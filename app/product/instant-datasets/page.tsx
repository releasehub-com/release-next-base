...
export const metadata: Metadata = {
  title: "Instant Datasets | Release",
  description:
  ...
  openGraph: {
    ...
    description:
      "Create instant, isolated datasets for your development and testing environments. Speed up your development process with Release's instant dataset cloning capabilities.",
    type: "article",
    url: "https://release.com/product/instant-datasets",
    images: [
      {
        url: "https://release.com/images/product/instant-datasets/header.webp",
        width: 2000,
        height: 1500,
  ...
  twitter: {
    ...
    description:
      "Create instant, isolated datasets for your development and testing environments. Speed up your development process with Release's instant dataset cloning capabilities.",
    images: ["https://release.com/images/product/instant-datasets/header.webp"],
  },
  alternates: {
    canonical: "https://release.com/product/instant-datasets",
  },
};
