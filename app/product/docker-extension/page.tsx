...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://release.com/images/product/docker-extension/header.svg",
        width: 2000,
        height: 1500,
  ...
  twitter: {
    ...
    description:
      "Instantly share local containers with customizable URLs. Test, preview, and QA earlier and faster throughout the SDLC.",
    images: ["https://release.com/images/product/docker-extension/header.svg"],
  },
  alternates: {
...
export default function DockerExtensionPage() {
  return (
    <RootSEOPageLayout
