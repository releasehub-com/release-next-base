...
export const metadata: Metadata = {
  ...
  description: "Seamlessly integrate Release with GitLab. Get production-like environments for every merge request and streamline your development workflow.",
  openGraph: {
    title: "GitLab Integration | Release",
    description: "Seamlessly integrate Release with GitLab. Get production-like environments for every merge request and streamline your development workflow.",
    type: "article",
