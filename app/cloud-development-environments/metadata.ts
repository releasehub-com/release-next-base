...
export const metadata: Metadata = {
  ...
  description: "Spin up cloud development environments in seconds. Give your developers the tools they need to be productive without managing infrastructure.",
  openGraph: {
    title: "Release - Cloud Development Environments",
    description: "Spin up cloud development environments in seconds. Give your developers the tools they need to be productive without managing infrastructure.",
    type: "article",
