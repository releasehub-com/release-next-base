export const bunnyshellFeatures = [
  ...
  },
  {
    ...
    competitor: true,
    description:
      "Release supports a wider range of IaC tools including Terraform, Helm, and Docker Compose. While Bunnyshell has IaC capabilities, Release offers more flexibility and integration options.",
  },
  {
    ...
    competitor: false,
    description:
      "Release's efficient resource allocation and management typically result in 40-60% cost savings on DevOps compared to Bunnyshell, especially for complex, multi-environment setups.",
  },
  {
