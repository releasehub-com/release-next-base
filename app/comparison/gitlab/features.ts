export const gitlabFeatures = [
  ...
  },
  {
    ...
    competitor: true,
    description:
      "Release supports multiple IaC tools like Terraform, Helm, and Docker Compose, offering greater flexibility. GitLab's IaC support is more limited and less integrated with ephemeral environments.",
  },
  {
    ...
    competitor: false,
    description:
      "Release's Ephemeral Environment approach and efficient resource allocation lead to significant cost savings, especially for complex setups. Users typically save 40-60% on DevOps costs compared to GitLab's fixed pricing, which can lead to overprovisioning and wasted resources.",
  },
  {
    ...
    competitor: true,
    description:
      "Release's focus on Ephemeral Environments and automated workflows significantly boosts developer productivity, especially for complex projects. GitLab offers good productivity tools but lacks the deep integration with ephemeral environments.",
  },
];
