...
export const metadata: Metadata = {
  ...
  description: "See how Release compares to other platforms and tools. Find out why leading teams choose Release for their environment management and deployment needs.",
  openGraph: {
    title: "Compare Release | Release",
    description: "See how Release compares to other platforms and tools. Find out why leading teams choose Release for their environment management and deployment needs.",
    type: "article",
