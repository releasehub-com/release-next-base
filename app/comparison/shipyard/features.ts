export const shipyardFeatures = [
  ...
  },
  {
    ...
    competitor: true,
    description:
      "Release supports a wider range of IaC tools including Terraform, Helm, and Docker Compose. Shipyard has IaC capabilities, but Release offers more flexibility and integration options.",
  },
  {
    ...
    competitor: false,
    description:
      "Release's efficient resource allocation and management typically result in significant cost savings, especially for complex, multi-environment setups. Users often report 40-60% savings on DevOps costs compared to Shipyard.",
  },
  {
    ...
    competitor: true,
    description:
      "Both platforms enhance developer productivity, but Release's deeper integration with ephemeral environments and more comprehensive automation tools often lead to greater efficiency gains.",
  },
];
