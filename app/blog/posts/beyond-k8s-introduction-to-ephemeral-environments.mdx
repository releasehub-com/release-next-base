...
showCTA: true
ctaCopy: >-
  Simplify environment setup with Release: automate ephemeral environments for
  seamless production mirroring and faster testing cycles.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=beyond-k8s-introduction-to-ephemeral-environments
relatedPosts:
  - ""
