...
showCTA: true
ctaCopy: >-
  Simplify managing Terraform environments with Release's ephemeral environments
  for seamless collaboration and consistent deployments.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=extending-releasehub-environments-with-terraform
relatedPosts:
  - ""
