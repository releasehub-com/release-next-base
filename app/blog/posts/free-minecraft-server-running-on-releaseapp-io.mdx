...
showCTA: true
ctaCopy: >-
  Unlock seamless collaboration and streamline Minecraft server setup with
  Release's ephemeral environments. Try now!
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=free-minecraft-server-running-on-releaseapp-io
relatedPosts:
  - ""
