...
showCTA: true
ctaCopy: >-
  <p id="">Explore how Release can boost developer happiness by setting up
  ephemeral environments for seamless development. </p><p id="">‍</p>
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=boost-dev-happiness
relatedPosts:
  - >-
