...
title: Table test
summary: ""
publishDate: "Sat Dec 03 2022 17:52:33 GMT+0000 (Coordinated Universal Time)"
author: ""
readingTime: 10
categories: &ref_0
...
showCTA: true
ctaCopy: >-
  Improve testing efficiency by automating environment setup and data
  manipulation with Release's environment management platform.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=table-test
relatedPosts:
  - ""
ogImage: /blog/default-og-image.png
excerpt: >-
  Step 1: Gather test data The first step, as exactly described above in Stack
  Overflow, is to run the AWS CLI to output a JSON list of all of your Route53
  ent...
tags: *ref_0
