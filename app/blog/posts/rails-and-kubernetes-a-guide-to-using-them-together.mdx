...
showCTA: true
ctaCopy: >-
  Streamline your Rails application deployment on Kubernetes with Release's
  on-demand environments for efficient testing and deployment workflows.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=rails-and-kubernetes-a-guide-to-using-them-together
relatedPosts:
  - ''
