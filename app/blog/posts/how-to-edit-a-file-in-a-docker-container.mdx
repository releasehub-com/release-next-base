...
showCTA: true
ctaCopy: >-
  Looking to edit files in Docker containers hassle-free? Try Release.com for
  ephemeral environments that simplify setup and teardown.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=how-to-edit-a-file-in-a-docker-container
relatedPosts:
  - ''
