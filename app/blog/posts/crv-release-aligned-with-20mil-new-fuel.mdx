...
showCTA: true
ctaCopy: >-
  Simplify dev workflows with on-demand environments like Release's Environments
  as a Service. Eliminate complexity, speed up deployments.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=crv-release-aligned-with-20mil-new-fuel
relatedPosts:
  - ""
