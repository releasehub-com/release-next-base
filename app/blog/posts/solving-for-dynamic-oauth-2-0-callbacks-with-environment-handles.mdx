...
showCTA: true
ctaCopy: >-
  Empower developers to easily manage dynamic OAuth callbacks with Release's
  flexible environment handles.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=solving-for-dynamic-oauth-2-0-callbacks-with-environment-handles
relatedPosts:
  - ""
