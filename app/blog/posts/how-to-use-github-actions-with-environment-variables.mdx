...
On the next page, you will give the new secret a name of **DOCKER\_PASSWORD**. Add the access token from the earlier section. After that, click on the **Add secret** button.

![](/blog-images/6584dab387bacd7a8884bbc995b3ac87.jpeg)

You'll also create another variable of DOCKER\_USERNAME and store the username here.
