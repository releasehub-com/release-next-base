...
showCTA: true
ctaCopy: >-
  [Automate infrastructure setup like AWS with Release's on-demand environments.
  Streamline workflows, reduce costs, and accelerate deployments.]
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=how-to-get-started-with-infrastructure-as-code-on-aws
relatedPosts:
  - ""
