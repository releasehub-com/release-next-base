...
showCTA: true
ctaCopy: >-
  Unlock seamless collaboration and faster testing with Release's on-demand
  environments, perfect for hands-on AWS re:Invent experiences.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=aws-re-invent-2023-what-to-expect
relatedPosts:
  - ""
