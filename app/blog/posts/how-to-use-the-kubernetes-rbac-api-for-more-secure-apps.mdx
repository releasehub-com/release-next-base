...
showCTA: true
ctaCopy: >-
  Unlock secure, on-demand Kubernetes environments with RBAC controls for
  streamlined app development and testing.
ctaLink: >-
  https://release.com/signup?utm_source=blog&utm_medium=cta&utm_campaign=blog-cta&utm_content=how-to-use-the-kubernetes-rbac-api-for-more-secure-apps
relatedPosts:
  - ""
