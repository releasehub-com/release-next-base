    ...
    return (
      <div className="space-y-4">
        ...
        {post.metadata.imageAssets && post.metadata.imageAssets.length > 0 && (
          <div
            className={`grid ${post.metadata.imageAssets.length === 1 ? "grid-cols-1" : "grid-cols-2"} gap-2 mt-4`}
          >
            ...
            <div className="mt-4 border border-gray-200 rounded-lg overflow-hidden bg-white">
              ...
              <div className="p-3">
                <h3 className="text-[15px] font-medium text-gray-900 line-clamp-2">
                  {post.metadata.pageContext.title}
                </h3>
                <p className="text-[13px] text-gray-400 mt-1">
                  {new URL(post.metadata.pageContext.url).hostname}
                </p>
              </div>
            </div>
          )}
        ...
        <div className="relative bg-gray-900 rounded-lg shadow-xl w-full max-w-2xl">
          <div className="flex items-center justify-between p-4 border-b border-gray-700">
            <div className="flex items-center space-x-3">
              ...
              <span
                className={`px-2 py-1 text-xs rounded-full border ${getStatusBadgeClass(post.status)}`}
              >
