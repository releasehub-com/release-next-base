...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Learn about ephemeral environments - temporary, production-like environments for development and testing. Understand key characteristics, benefits, and how to implement them in your workflow.",
    type: "article",
    url: "https://release.com/ephemeral-environments",
    images: [
      {
        url: "https://release.com/og/ephemeral-environments.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Learn about ephemeral environments - temporary, production-like environments for development and testing. Understand key characteristics, benefits, and how to implement them in your workflow.",
    images: ["https://release.com/og/ephemeral-environments.png"],
  },
  alternates: {
    canonical: "https://release.com/ephemeral-environments",
  },
};
