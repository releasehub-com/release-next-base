...
export const VERSIONS = {
  'ephemeral': {
    ...
    content: {
      title: "Full-stack on-demand environments for every stage of your application lifecycle.",
      benefits: [
        {
          icon: "cost-reduction",
          title: "Cut environment costs by 75%",
          description: "Navan reduced environment creation time from 8 days to 5 minutes."
        },
        {
          icon: "testing",
          title: "Cut testing time up to 99%",
          description: "Chipper Cash migrated from Heroku and reduced testing time from 24 hours to < 5 minutes."
        },
        {
          icon: "developer",
          title: "Increase engineer delight 100%",
          description: "DispatchHealth increased feature deployment velocity from 2 to 10+ features a week."
        }
      ],
      steps: [
      ...
      benefits: [
        {
          ...
          description: "Spin up full development environments in seconds, complete with all your tools and dependencies."
        },
        {
          icon: "collaboration",
        ...
        },
        {
          ...
          description: "Eliminate local setup headaches with automated environment provisioning and configuration."
        }
      ],
      steps: [
        "Connect your repositories",
      ...
      benefits: [
        {
          ...
          description: "Deploy models with sub-100ms latency. Our optimized infrastructure ensures rapid response times for your AI applications."
        },
        {
          icon: "scale",
          title: "Seamless Scalability",
          description: "Automatically scale from zero to thousands of concurrent requests. Our platform grows with your needs, ensuring consistent performance."
        },
        {
          icon: "security",
          title: "Enterprise-Grade Security",
          description: "Benefit from SOC 2 Type II compliance, private networking, and end-to-end encryption. Your models and data remain secure and compliant."
        }
      ],
      steps: [
      ...
      benefits: [
        {
          ...
          description: "Deploy applications with a simple git push, just like Heroku but with more power."
        },
        {
          icon: "scale",
          title: "Scale Without Limits",
          description: "Start with our hosted platform, then seamlessly upgrade to enterprise features as you grow."
        },
        {
          icon: "cloud-provider",
          title: "Full Cloud Provider Access",
          description: "Direct access to AWS, GCP, or Azure services while maintaining the simple developer experience."
        }
      ],
      steps: [
        "Push your code",
      ...
      benefits: [
        {
          ...
          description: "Release handles node autoscaling, version upgrades, and resource deployment automatically, reducing operational overhead."
        },
        {
          icon: "kubernetes",
          title: "Flexible Configuration",
          description: "Customize your application's build and deployment processes with simple .release.yaml files and native Kubernetes manifests."
        },
        {
          icon: "cloud-provider",
          title: "Cloud Integration",
          description: "Create and manage Kubernetes clusters within your own cloud account for maximum control and security."
        }
      ],
      steps: [
      ...
      benefits: [
        {
          ...
          description: "Automatically create environments for every merge request with zero configuration."
        },
        {
          icon: "pipeline",
          title: "Enhanced CI/CD Pipelines",
          description: "Integrate with GitLab CI/CD for automated testing and deployment workflows."
        },
        {
          icon: "collaboration",
          title: "Streamlined Reviews",
          description: "Accelerate code reviews with instant preview environments for every change."
        }
      ],
      steps: [
...
export type ValidVersion = VersionId | typeof VERSIONS[VersionId]['aliases'][number]
...
export const getVersionPath = (version: VersionId) => 
