...
import { Database, ArrowRight, Terminal, Code, GitBranch, Link2, GitPullRequest, Clock, TestTube, Repeat } from 'lucide-react'
          ...
          {[
            {
              ...
              description: "Generate full-stack environments automatically for every pull request or by using GitHub labels, enabling comprehensive testing and review workflows.",
              links: [
                {
            ...
            },
            {
              ...
              description: "Provision environments automatically using GitOps integration. Each environment comes with secure, shareable links for easy collaboration and review.",
              links: [
                {
            ...
            },
            {
              ...
              description: "Offer remote development environments that can be 'mounted' to a developer's local computer, facilitating seamless development workflows.",
              link: {
            ...
            },
            {
              ...
              description: "Provide on-demand environments that scale to zero when inactive, resulting in significant reductions in pre-production cloud costs. Environments can be created only when needed, put on a schedule, or paused, leading to savings ranging from 30-70%.",
              link: {
            ...
            },
            {
              ...
              description: "Utilize Release's Instant Datasets to create and manage realistic datasets for testing and development, enabling data-driven testing and replication of production-like scenarios.",
              link: {
            ...
            },
            {
              ...
              description: "Create and deploy Release environments, stream logs, and manage your infrastructure directly from the command line with our powerful CLI tool.",
              link: {
            ...
            <Card key={index} className="bg-gray-700 border-gray-700 hover:border-[#00bb93] transition-colors duration-300">
              <CardHeader>
              ...
              <CardContent>
                ...
                {feature.link && (
                  <Link href={feature.link.href} className="flex items-center text-[#00bb93] hover:underline mt-4">
                ...
                {feature.links && (
                  <div className="space-y-2 mt-4">
                    {feature.links.map((link, i) => (
                      <Link key={i} href={link.href} className="flex items-center text-[#00bb93] hover:underline">
