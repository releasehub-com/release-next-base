...
import { FileText, Cloud, Key, Database, GitBranch, Shield, Zap, Puzzle, Wand2, LinkIcon, Workflow } from 'lucide-react'
              ...
              <div className="flex-1">
                <ul className="space-y-4 text-gray-300">
                  <li className="flex items-start">
                    ...
                    <span>Single source of truth for managing applications and environments</span>
                  </li>
                  <li className="flex items-start">
                    <Zap className="mr-2 h-5 w-5 text-[#00bb93] mt-1 flex-shrink-0" />
                    <span>Encapsulates years of experience and best practices from hundreds of customer setups</span>
                  </li>
                  <li className="flex items-start">
                    <Puzzle className="mr-2 h-5 w-5 text-[#00bb93] mt-1 flex-shrink-0" />
                    <span>Simplifies configuration and deployment for smooth onboarding and efficient operations</span>
                  </li>
                  <li className="flex items-start">
                    <Wand2 className="mr-2 h-5 w-5 text-[#00bb93] mt-1 flex-shrink-0" />
                    <span>Auto-generation from customer repositories for easy start-up</span>
                  </li>
                  <li className="flex items-start">
                    <Workflow className="mr-2 h-5 w-5 text-[#00bb93] mt-1 flex-shrink-0" />
                    <span>Built-in workflow engine for custom environment creation and teardown actions, including database migrations</span>
                  </li>
                </ul>
                <div className="mt-6">
                  <Link href="https://docs.release.com/reference-documentation/application-settings/application-template">
                    <Button variant="outline" className="w-full md:w-auto border-[#00bb93] text-[#00bb93] hover:bg-[#00bb93] hover:text-white">
