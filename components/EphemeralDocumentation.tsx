      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-300">
            We've made a massive investment in building world-class developer
            documentation and support. Built by developers, for developers.
            Everything you need to succeed with Release.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="relative">
              ...
              <div className="pl-6">
                ...
                <p className="text-gray-300">
                  Our documentation covers every feature, providing detailed
                  instructions and examples for configuring and managing
                  environments.
                </p>
                <Link
            ...
            <div className="relative">
              ...
              <div className="pl-6">
                ...
                <p className="text-gray-300">
                  Easily find answers using our AI-powered search engine, which
                  allows users to ask questions and quickly locate solutions to
                  common challenges.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="pl-6">
                ...
                <p className="text-gray-300">
                  Every new feature we build is released alongside tested
                  documentation, ensuring reliability and clarity for all users.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="pl-6">
                ...
                <p className="text-gray-300">
                  Every customer gets a dedicated Slack channel directly
                  connected to our engineers. It's like having a team of Senior
                  DevOps Engineers at your disposal to help solve any issue you
                  encounter.
                </p>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                <div className="mt-8">
                  <p className="text-gray-300 mb-6">
                    With these tools and resources, adopting and scaling Release
